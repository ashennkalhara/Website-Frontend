...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-row justify-between items-center lg:px-32 px-5 bg-[url('./assets/img/home.jpg')] bg-cover bg-no-repeat">
  <div className="absolute inset-0 bg-black opacity-50"></div>
  <div className="relative w-full lg:w-2/3 space-y-5">
